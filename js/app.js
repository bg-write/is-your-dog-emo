...
activateBtn.addEventListener('click', ()=> { // when you click on the button, the following event happens ...
    fetch("https://random.dog/woof.json") // fetch the randomDog API ...
    .then((response) => { // and then return it as a promise (a response) ...
    ...
    .catch((err) => { // finally, we catch any errors ...
...
activateBtn.addEventListener('click', ()=> { // when you click on the button, the following event happens ...
    ...
    .then((genre) => { // then we do the following to the promise, now defined as "genre" ..
        // console.log(genre); // turn this on for testing
        ...
        if (newGenreStringUpperCase.includes('EMO')) { // and establish new if statement; if the genre includes "EMO" ...
            // console.log('yes.'); // turn this on for testing
        ...
        } else { // if the genre does not include "EMO" ...
            // console.log('no.'); // turn this on for testing
